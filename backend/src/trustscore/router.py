...
from src.trustscore.schemas import (
    TrustScoreCreate,
    TrustScoreUpdate,
    TrustScore,
    CalculatedTrustScore,
)
from src.trustscore.service import (
    create_trust_score,
    get_trust_scores,
    get_trust_score,
    update_trust_score,
...
def post_trust_score(
    trust_score: TrustScoreCreate,
...
def get_trust_score_endpoint(
    trust_score_id: str, db: Session = Depends(get_db), auth=Depends(authentication)
):
    """
