...
class Operator(Base):
  ...
  aoc_part135 = Column(String(255), nullable=True)
  is_bao = Column(String(50), nullable=True)
  acsf_ias = Column(String(50), nullable=True)
  telephone = Column(String(50), nullable=True)
  email = Column(String(255), nullable=True)
  website = Column(String(512), nullable=True)
  faa_operator_name = Column(String(255), nullable=True)
  faa_dsgn_code = Column(String(10), nullable=True)
  faa_ceo = Column(String(255), nullable=True)
  faa_city = Column(String(100), nullable=True)
