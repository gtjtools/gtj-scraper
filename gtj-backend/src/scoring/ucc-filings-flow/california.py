...
class CaliforniaFlow(BaseUCCFlow):
    ...
    async def fill_search_form(self, page: Page, search_query: str) -> bool:
        ...
        TODO: Implement specific selectors for California's UCC search form
        This is a template - needs to be customized based on California's actual form
        """
        try:
            # Example selectors - NEEDS TO BE CUSTOMIZED
            # Uncomment and modify based on actual California page structure

            # await page.fill('input[name="debtor_name"]', search_query)
            # await page.click('button[type="submit"]')
            # await page.wait_for_load_state('networkidle')

            print("⚠️  California search form filling not yet implemented")
            print("   Please inspect the page and add proper selectors")

            # Take screenshot to help with implementation
            await self.take_screenshot(page, f"california_search_form.png")
    ...
    async def extract_results(self, page: Page) -> Dict[str, Any]:
        ...
        TODO: Implement specific extraction logic for California
        This is a template - needs to be customized based on California's actual results
        """
        try:
            ...
            print("⚠️  California results extraction not yet implemented")
            print("   Please inspect the page and add proper extraction logic")

            # Take screenshot to help with implementation
            await self.take_screenshot(page, f"california_results.png")
